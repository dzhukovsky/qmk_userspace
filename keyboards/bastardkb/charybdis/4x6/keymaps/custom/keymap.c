...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_SYM] = LAYOUT(
       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
       XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR,  KC_GRV, XXXXXXX,    XXXXXXX, KC_AMPR, KC_ASTR, KC_PLUS, KC_TILD, XXXXXXX,
       XXXXXXX, KC_PIPE, KC_LPRN, KC_RPRN, KC_QUOT, XXXXXXX,    XXXXXXX,  KC_DLR, KC_PERC, KC_CIRC, KC_MINS, XXXXXXX,
       XXXXXXX, KC_BSLS, KC_LBRC, KC_RBRC, KC_DQUO, XXXXXXX,    XXXXXXX, KC_EXLM,   KC_AT, KC_HASH, KC_UNDS, XXXXXXX,
